  ...
  if (username === null) {
    ...
    const error = new Error400(
      ...
      <div>
        ...
        <form action="https://github-profile-trophy-weld-theta.vercel.app/" method="get">
          ...
          <text>
            ...
            <a href="https://github.com/delitamakanda/github-profile-trophy?tab=readme-ov-file#apply-theme" target="_blank">here</a>
          </text>
          <br>
      ...
      <script>
        const base = "https://github-profile-trophy-weld-theta.vercel.app/";
